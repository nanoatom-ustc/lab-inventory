    ...
    if os.path.exists(INVENTORY_FILE):
        ...
        initial_data = {
            "产品名称": [
                ...
                "PBS 10M", "反射镜架（新）", "可变光阑",
                # 新增的光学元件
                "PBS 780 nm", "PBS 960 nm", "PBS 480 nm", 
                "半波片 780 nm", "半波片 960 nm", "半波片 480 nm",
                "四分之一波片 780 nm", 
                "双色镜 960/480 nm", "二向色性反射镜 780 nm", 
                "干涉滤光片 480 nm", 
                "非球面透镜 f=8 mm", "光纤耦合透镜"
            ],
            "当前数目": [
                8, 11, 21, 45, 27, 5, 12, 2, 30, 1, 2, 8, 6, 20, 5, 20, 39, 8,
                # 补充的光学元件数量（可根据实验室实际情况调整）
                5, 3, 3, 
                6, 4, 4, 
                5, 
                2, 4, 
            ...
            "分类": [
                "光纤准直器", "准直器调整架", "套筒", "套筒", "压板", "底座", "位移台", "笼板", "笼板", "笼板",
                "架子", "架子", "架子", "架子", "架子", "架子", "架子", "光阑",
                # 补充的光学元件分类
                "偏振分束器", "偏振分束器", "偏振分束器",
                "波片", "波片", "波片",
                "波片",
