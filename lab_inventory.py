...
def load_inventory():
    if os.path.exists(INVENTORY_FILE):
        ...
        # 基于上传文件计算的初始库存数据，已补充光学元件
        initial_data = {
            "产品名称": ['lbtek PRADFCD-11-B-APC', 'lbtek MT-AM05S3', 'OMPH12D-20M', 'OMPH12D-40M', 'Y形压板', '圆形底座', 'z轴', '笼板 SM05', '笼板 SM1', '笼板 25.4通孔', '笼式玻片架', '笼式45度反射镜架', '笼式90度反射镜架', 'BD架', 'PBS架 M05', 'PBS 10M', '反射镜架（新）', '可变光阑', '半波片 780 nm', '半波片 852 nm', '四分之一波片 780 nm', '四分之一波片 852 nm', '透镜 f100 700-1100nm', '透镜 f200 700-1100nm', '透镜 f250 700-1100nm', '透镜 f500 700-1100nm', '反射镜 750-1100nm', '高功率反射镜 780，852nm', '双色片@780，852nm', '780 滤光片', 'PBS 852nm d=12.7', 'PBS 700-900nm d=12.7', 'PBS 700-900nm d=10', 'AOM 60MHz', 'AOM 80MHz', 'AOM 100MHz', 'AOM 110MHz', 'AOM 130MHz', 'AOM 150MHz'],
            "当前数目": [8, 11, 21, 45, 27, 5, 12, 2, 30, 1, 2, 8, 6, 20, 5, 20, 39, 8, 5, 30, 17, 16, 20, 2, 2, 2, 41, 7, 17, 8, 2, 10, 17, 1, 2, 1, 14, 1, 1],
            "分类": ['光纤准直器', '准直器调整架', '套筒', '套筒', '压板', '底座', '位移台', '笼板', '笼板', '笼板', '架子', '架子', '架子', '架子', '架子', '架子', '架子', '光阑', '波片', '波片', '波片', '波片', '透镜', '透镜', '透镜', '透镜', '反射镜', '反射镜', '双色片', '滤光片', 'PBS', 'PBS', 'PBS', 'AOM', 'AOM', 'AOM', 'AOM', 'AOM', 'AOM']
        }
        }
